...
<html lang="en">
  <head>
        ...
        <title>3star club</title>
  </head>
    <body>
        <a href="logout.php" class="btn btn-info">Logout</a>
         <?php
            echo '<h1 class="btn btn-success">'.$_GET['msg'].'</h1>';
                ...
                <div class="col-lg-9">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0 px-lg-5 ">
                        <a href="index.html" class="navbar-brand d-block d-lg-none">
                            <h1 class="m-0 display-4 text-primary text-uppercase text-danger"  style="font-size:3rem; font-family:serif;">3Star club</h1>
                        </a>
                        ...
                        <div class="collapse navbar-collapse justify-content-between h-100" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0 ">
                                <a href="home.php" class="nav-item nav-link active text-uppercase" style="color:red"><b>Home</b></a>
                                <a href="" class="nav-item nav-link text-uppercase">Services</a>
                                <a href="" class="nav-item nav-link text-uppercase">About</a>
                                <a href="" class="nav-item nav-link text-uppercase">Contact</a>   
                            </div>
                        </div>
                    </nav>
                </div>
                ...
                <div class="row px-3">
                    ...
                    <div class="col-md-6 p-0">
                        <div class="gym-class-box d-flex flex-column align-items-start justify-content-center bg-danger text-right text-white py-5 px-5">
                            <a href="about.html"  style="text-decoration:none"><h2 class="display-4 mb-3 text-white">About</h2></a>
                    ...
                    <div class="col-md-6 p-0">
                        <div class="gym-class-box d-flex flex-column align-items-start justify-content-center bg-dark text-left text-white py-5 px-5">
                            ...
                            <a href="services.html" style="text-decoration:none ;"><h3 class="display-4 mb-3 text-white">Services</h3></a>
            ...
            <div class="footer container-fluid bg-dark text-white mt-5">
                <div class="row pt-5">
                    <div class="col-lg-3 col-md-6 mb-5">
                        ...
                        <p><i class="fa fa-phone-alt mr-2"></i>+92 300 1234567</p>
                        <p><i class="fa fa-envelope mr-2"></i>3starclub@yahoo.com</p>
